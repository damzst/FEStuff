...
##############################################################################
# Funcion que corrige una imagen fisheye centrandola en (u,v), usando el MUI
def corregir(src,u,v):
  ...
  # Se proyectan los puntos desde la esfera rotada hacia el plano imagen PTZv
...
def warp(src,u,v,li,mi,si,ni,wi,fovi):
  ...
  return ptzv
#########################################################################################
# Funcion que calcula r en funcion de theta, usando el Modelo Unificado
def MIUr(theta,l,m):

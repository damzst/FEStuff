...
out = cv2.VideoWriter('viga_blobs.avi', #Nombre
...
while(cap.isOpened()):
  ...
  if not ret: break
  # Se escala la imagen para reducir tiempo de procesamiento  
  ...
  fotogramaConMascara = cv2.bitwise_and(fotogramaEscalado, #Imagen origen
...
with open('trayectorias.pkl','wb') as output:
